...
class Btag extends Resource
{
	public static $modelClass = \Alexr\Models\BTag::class;
	...
	public static function label() {
		return __eva('Booking Tags');
	}

	public static function labelSingular() {
		return __eva('Booking Tag');
	}
	...
	public function fields(Request $request)
	{
		return [
			...
			BelongsTo::make(__eva('Group'), 'group', Btaggroup::class),
